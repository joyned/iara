                        ...
                        <div className="flex flex-col gap-2">
                            ...
                            <div className="flex flex-col items-end">
                                <div className="flex items-center gap-2">
                                    <TiDeleteOutline className="text-yellow-500" />
                            ...
                            <div className="flex justify-between">
                                <div className="flex gap-3">
                                    <Button type="button" onClick={onAddVersion}>Add Version</Button>
                                    <Button type="button" variant="outline" onClick={() => navigate('/secrets')}>Cancel</Button>
                                </div>
                                <ConfirmDialog onConfirm={onDeleteSecret}>
                                    <Button type="button" variant="danger">Delete Secret</Button>
                                </ConfirmDialog>
                            </div>
                        </div>
                    }
